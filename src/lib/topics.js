...
//   yesno   (한 장으로 판정)          → 할까 말까
//
// 한 분류 안에서 같은 스프레드가 몰리지 않게 섞었다. 아홉 줄이 전부 '예/아니오'면
...
export const TOPICS = [
  ...
  { id: 'loveMiss',     cat: 'love',  spread: 'three',   card: 'm18' },  // 달 — 안 보이는 것
  ...
  { id: 'lifeImportant',cat: 'life',  spread: 'three',   card: 'm21' },  // 세계 — 전체를 봄
  ...
  { id: 'lifeHold',     cat: 'life',  spread: 'three',   card: 'm15' },  // 악마 — 붙잡힌 것
