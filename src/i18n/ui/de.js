...
export default {
  ...
  result: {
    ...
    togetherOne: "Wenn du diese Karte liest",
  },
  ...
  topicLeads: {
    ...
    loveGo: { answer: "Was tatsächlich folgt, wenn du mit dieser Person weitermachst – der Grund, warum die Antwort oben so ausgefallen ist." },
    loveNeed: { situation: "Was zwischen euch beiden gerade tatsächlich da ist.", action: "Das eine, das du dieser Beziehung jetzt dazugeben sollst – zeigt die Karte eine Lücke oder einen Riss, dann ist die Antwort, genau das zu schließen.", result: "Wo ihr zwei ankommt, sobald dieses eine da ist." },
    ...
    loveHonest: { answer: "Ob du es aussprechen sollst – und was zwischen euch tatsächlich in Bewegung kommt, sobald es gesagt ist." },
    ...
    crushAgain: { answer: "Ob es einen Weg zurück zueinander gibt – und welche Form dieser Weg annimmt, während er sich öffnet oder schließt." },
    ...
    crushConfess: { situation: "Wo ihr zwei steht, bevor du der Person sagst, was du fühlst.", action: "Die innere Haltung, mit der du es sagst, wenn du dich dafür entscheidest.", result: "Wie die Person es aufnimmt, sobald sie es weiß, und wo euch zwei das hinbringt." },
    crushLetGo: { answer: "Ob es Zeit ist, das loszulassen, und warum – diese Karte bist du an der Schwelle zum Loslassen, nicht die andere Person." },
    crushSilence: { now: "Wo ihr zwei steht, seit die Person still geworden ist.", block: "Der wahre Grund, warum die Person still geworden ist – etwas auf ihrer Seite oder etwas, das sich zwischen euch geschoben hat.", move: "Was den Draht wieder öffnen würde – ein Schritt, den du machen kannst, oder ein Zeichen, erst mal abzuwarten." },
    ...
    workTalent: { have: "Was du schon gut kannst, auch wenn du es nie so genannt hast: mit dem, was diese Karte zeigt, besser umgehen als die meisten.", thin: "Die Fähigkeit, die dir noch fehlt, direkt neben der, die du hast.", use: "Wo dieses Talent wirklich zählt." },
    workStay: { answer: "Ob du bleiben sollst, wo du bist, und der Grund hinter dem Urteil – was dieser Platz dir gibt oder was er dir still und leise nimmt." },
    ...
    lifeImportant: { pull: "Was von allem, was gerade vor dir liegt, am stärksten an dir zieht.", real: "Das eine, das dir noch wichtig ist, wenn der Lärm sich gelegt hat.", first: "Das Erste, das du anpackst, jetzt, wo du siehst, was zählt." },
    ...
    lifeSave: { now: "Wie Geld bei dir gerade kommt und geht.", block: "Der wahre Grund, warum bei dir nie etwas übrig bleibt.", move: "Was dafür sorgen würde, dass endlich etwas übrig bleibt." },
    ...
    healthSignal: { seen: "Das Signal deines Körpers, das du schon bemerkt hast.", unseen: "Worum dein Körper dich mit diesem Bild die ganze Zeit bittet – und was du immer wieder übergehst.", know: "Was sich daran ändert, wie du für deinen Körper sorgst, sobald du hinhörst." },
    ...
    healthBirth: { have: "Die Kraft, die du schon in die Geburt mitbringst.", thin: "Was dir noch fehlt, während die Geburt näher rückt.", use: "Der Moment, in dem du nach dieser Kraft greifen wirst, wenn die Geburt näher rückt." },
  },
  ...
  topicClose: {
    ...
    loveGo: "Das Wort oben sagt, ob du mit dieser Person weitermachen sollst; die Karte darunter ist der Grund. Bei Ja zeigt sie, was das Dranbleiben von dir verlangen würde; bei Nein, was dir zum Aufhören rät; bei Noch nicht, was sich erst legen muss. Bleib länger bei der Karte als beim Wort.",
    loveNeed: "Deine Antwort ist die zweite Karte, also bleib dort am längsten – was diese Beziehung braucht, ist etwas, das du selbst tun kannst. Nennt die Karte etwas, das zu tun ist, dann ist das die Antwort; zeigt sie eine Lücke oder einen Riss, dann ist es das Schließen davon. Die erste Karte sagt, warum das gerade jetzt gebraucht wird, die dritte, wie weit ihr zwei kommt, sobald es da ist.",
    ...
    loveHonest: "Das Urteil oben sagt, ob du es aussprechen sollst; die Karte darunter ist der Grund, also bleib länger bei der Karte als beim Wort. Bei Ja sagt sie, was das Aussprechen zwischen euch öffnet. Bei Nein, was vor den Worten erst in Ordnung gebracht werden muss. Bei Noch nicht, was sich erst beruhigen muss, bevor Platz für sie ist. Ein Nein heißt nicht 'schluck es runter', sondern 'nicht so' – lies aus der Karte also, was als Erstes aufeinanderprallen würde, wenn du es jetzt sagst, und wie du es stattdessen sagen kannst.",
    ...
    crushApproach: "Die Antwort oben sagt, ob du den ersten Schritt machen sollst; die Karte darunter sagt, warum. Bleib länger bei der Karte als bei der Antwort – bei Ja sagt sie, wie du es angehst; bei Nein, woran du dich stoßen würdest, wenn du dich jetzt bewegst; bei Noch nicht, was sich erst legen muss, bevor du losgehst.",
    ...
    crushAgain: "Die Antwort oben sagt, ob es einen Weg zurück zueinander gibt; die Karte darunter ist die Form dieses Weges. Wovon die Karte auch zu reden scheint – lies sie als den Weg zurück. Bei Ja zeigt sie, wie sich dieser Weg öffnet und was er von dir verlangt; bei Nein, was ihn versperrt; bei Noch nicht, was sich erst legen muss. Bleib länger bei der Karte als beim Wort oben.",
    ...
    crushConfess: "Du hast gefragt, was passiert, wenn du es sagst – das ist die dritte Karte, also bleib dort am längsten. Sie zeigt, wie die Person es aufnimmt und wo euch zwei das hinbringt. Die erste zeigt, wo ihr steht, bevor du etwas sagst, und die zweite ist die Haltung, die ihre Reaktion prägt – lies die dritte also als das, was zurückkommt, wenn du es mit dieser Haltung sagst, nicht für sich allein.",
    crushLetGo: "Das Wort oben sagt, ob es Zeit ist, das loszulassen; die Karte darunter ist der Grund. Lies diese Karte als dich, nicht als die andere Person – du an der Schwelle zum Loslassen. Heißt es Ja, zeigt die Karte, was in den Platz kommt, den du frei machst; bei Nein, was unerledigt ist und dich noch hält; bei Noch nicht, was in dir erst klar werden muss, bevor die Antwort es werden kann. Bleib länger bei der Karte als beim Wort – wie du loslässt oder warum du festhältst, steht dort.",
    crushSilence: "Du hast gefragt, warum die Person still geworden ist – das ist die zweite Karte, also bleib dort am längsten. Lies ihren Text als etwas über diese Person: Zeigt sie einen Menschen, dann ist das der Ort, an dem die Aufmerksamkeit dieser Person gerade liegt; sonst ist es der Zustand, in dem sie gerade steckt, oder das, was sich zwischen euch geschoben hat. Die erste Karte ist, wo ihr zwei in der Stille steht; die dritte, was du tust, sobald du den Grund kennst – dich melden oder abwarten.",
    ...
    workTalent: "Die erste Karte ist, was du gut kannst – die Antwort auf deine Frage. Kam sie schwer daher, ist das kein Makel: Es heißt, dass du dieses Gelände öfter durchquert hast als die meisten und schon weißt, wie man damit umgeht – und genau dieses Wissen ist das Talent. Die zweite Karte ist, wo dieses Talent dünn wird, die dritte, wo es wirklich zählt. Bleib am längsten bei der ersten, und schau bei der dritten nach, wo du es einsetzt.",
    workStay: "Das Wort oben ist das Urteil übers Bleiben – Ja, Nein oder Noch nicht – und die Karte darunter ist der Grund. Bei Ja lies die Karte als das, was dieser Platz dir noch gibt oder was du hier noch zu Ende bringen sollst; bei Nein als das, was er dir still und leise nimmt; bei Noch nicht als das, was sich erst legen muss, bevor die Antwort trägt. Bleib länger bei der Karte als beim Wort – ob du bleibst oder gehst, der nächste Schritt steht dort.",
    workPeople: "Die erste Karte ist, was du mitbringst, die zweite die Person, die du zu deuten versuchst, die dritte, was im Job wirklich zwischen euch läuft. Bleib am längsten bei der zweiten – das ist die Deutung, nach der du gefragt hast – und prüf sie an der dritten. Wo die beiden sich widersprechen, hast du die Person bisher falsch gelesen, und die erste Karte sagt dir, was auf deiner Seite diese Lücke offen hält.",
    ...
    lifeChoice: "Das Wort oben ist das Urteil darüber, ob du es wagen sollst – Ja, Nein oder Noch nicht. Die Karte darunter ist der Grund. Bei Ja sagt sie, was der Schritt von dir verlangen würde; bei Nein, was dich davor warnt; bei Noch nicht, was sich erst legen muss, bevor du dich entscheidest. Bleib länger bei der Karte als beim Wort – das Wort sagt nur, ob; die Karte sagt, was du daraus machst.",
    ...
    lifeSpend: "Das Urteil oben sagt, ob sich diese Ausgabe lohnt – Ja, Nein oder Noch nicht – und der Kartentext ist der Grund. Bei Ja sagt er dir, was du für das Geld wirklich bekommst; bei Nein, was dich die Ausgabe über den Preis hinaus kosten würde, oder warum nicht jetzt; bei Noch nicht, was sich erst legen muss, bevor du das Portemonnaie aufmachst. Danach lies ihn – nicht nach dem Preisschild.",
    lifeImportant: "Du hast gefragt, was gerade am meisten zählt, und die zweite Karte ist die Antwort – bleib dort am längsten. Die erste Karte ist, wo deine Aufmerksamkeit tatsächlich war: Sagt sie dasselbe wie die zweite, ist dein Herz schon am richtigen Platz; sagt sie etwas anderes, ist das genau die Strecke, um die dein Blick abgedriftet ist. Die dritte Karte ist das eine, das du zuerst anpackst – für das, was zählt.",
    ...
    lifeSave: "Die erste Karte ist, wie Geld bei dir gerade kommt und geht, die zweite der wahre Grund, warum nie etwas übrig bleibt, die dritte, was es zum Bleiben bringen würde. Du hast nach dem Warum gefragt, also bleib am längsten bei der zweiten – die dritte ergibt erst Sinn, wenn du den Grund gesehen hast. Ist die zweite Karte eine dunkle, dann ist das das Leck; sieht sie nach guter Nachricht aus, dann geht dein Geld zuerst dorthin.",
    ...
    healthSignal: "Die erste Karte ist das Signal deines Körpers, das du schon gespürt hast, die zweite, worum er dich dahinter die ganze Zeit bittet, die dritte, was sich daran ändert, wie du für ihn sorgst, sobald du diese Bitte hörst. Lies die erste und die zweite nebeneinander – der Abstand zwischen ihnen ist der Teil, den du bisher überhört hast. Bleib am längsten bei der zweiten: Welches Bild auch kam, es zeigt, was dein Körper will, also übersetz es in seine Sprache. Darauf hat er gewartet – dass du es bemerkst.",
    ...
    healthRest: "Das Wort oben ist das Urteil darüber, ob du jetzt innehalten und eine Weile ausruhen darfst; die Karte darunter ist der Grund. Bei Ja zeigt sie, was die Pause dir zurückgibt, oder wie du ruhst, damit es wirklich Ruhe ist. Bei Nein oder Noch nicht zeigt sie, was dich gerade vom Ausruhen abhält. Auch wenn die Karte nicht nach Ruhe aussieht: Lies, was sie beschreibt, als ginge es darum, dass du jetzt anhältst. Ein Nein oder Noch nicht heißt nicht 'weitermachen' – es heißt, dass erst etwas abgelegt werden muss, damit die Pause wirklich eine ist. Es geht um den Zeitpunkt, nicht darum, ob du sie verdient hast. Die Karte sagt mehr als das eine Wort, also bleib länger dort.",
    ...
    healthMind: "Die erste Karte ist die Antwort – was dir Halt gibt, wenn es schwer wird, musst du nicht erst aufbauen; es trägt dich schon. Die zweite ist die Stelle, die wackelt, wenn du dein ganzes Gewicht dorthin legst – lies sie als Zeichen, dieses Gewicht auf die erste zu verlagern. Die dritte ist, welcher Teil eines schweren Tages zuerst leichter wird, sobald du das tust. Bleib am längsten bei der ersten – an schweren Tagen fang bei dem an, was dich schon hält, bevor du nach etwas Neuem suchst.",
    ...
    healthBirth: "Die erste Karte ist die Kraft, die du schon in die Geburt mitbringst, die zweite, was dir noch fehlt, die dritte der Moment, in dem du nach dieser Kraft greifen wirst. Bleib am längsten bei der ersten – das ist die Antwort auf deine Frage, und sie steckt schon in dir. Die zweite zeigt nur, wo du bis zu dem Tag nachsichtig mit dir sein darfst, und die dritte ist keine Vorhersage für den Tag, sondern der Moment, in dem du an die erste Karte denkst – sieht die dritte schwer aus, ist das genau der Moment, für den die erste da ist.",
  },
