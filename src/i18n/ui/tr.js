...
export default {
  ...
  topicLeads: {
    ...
    loveGo: { answer: "Bu kişiyle devam ederseniz gerçekte peşinden gelecek olan — yukarıdaki cevabın neden öyle çıktığı." },
    loveNeed: { situation: "İkinizin şu an elinde gerçekte olan şey.", action: "Bu ilişkiye şu an eklemeniz gereken tek şey — kart bir boşluğu ya da gerginliği gösteriyorsa, onu doldurmak cevaptır.", result: "O tek şey eklendiğinde bu ilişkinin dönüşeceği hâl." },
    ...
    loveHonest: { answer: "Açıkça söyleyip söylememeniz gerektiğinin cevabı ve söylendiğinde aranızda gerçekte kımıldayacak olan." },
    ...
    crushAgain: { answer: "Birbirinize dönüş yolu olup olmadığı ve o yolun açılırken ya da kapanırken aldığı biçim." },
    ...
    crushConfess: { situation: "Hislerinizi söylemeden önce aranızın durduğu yer.", action: "Söylemeye karar verirseniz, o sözü hangi ruh hâliyle söyleyeceğiniz.", result: "Öğrendiğinde bunu nasıl karşılayacağı ve ikinizi nerede bırakacağı." },
    ...
    crushSilence: { now: "O sustuğundan beri ikinizin durduğu yer.", block: "Onun susmasının gerçek sebebi — kendi tarafındaki bir şey ya da aranıza giren bir şey.", move: "Aranızdaki hattı yeniden açacak olan — sizin atabileceğiniz bir adım ya da şimdilik beklemeniz gerektiğinin işareti." },
    ...
    workTalent: { have: "Hiç adını koymamış olsanız da zaten iyi yaptığınız şey — bu kartın gösterdiği durumu çoğu insandan daha iyi idare etme gücü.", thin: "İyi olduğunuz şeyin hemen yanında, hâlâ eksik kalan beceri.", use: "O yeteneğinizin gerçekten değer bulduğu yer." },
    workStay: { answer: "Bulunduğunuz yerde kalıp kalmamanızın cevabı ve arkasındaki sebep — bu yerin size verdiği ya da sizden sessizce aldığı şey." },
    ...
    lifeImportant: { pull: "Şu an önünüzde duran her şey içinde sizi en güçlü çeken.", real: "Gürültü dinince sizin için hâlâ önemli olacak tek şey.", first: "Neyin önemli olduğunu gördüğünüze göre, şimdi ilk elinize alacağınız şey." },
    ...
    lifeSave: { now: "Paranın şu an size nasıl gelip gittiği.", block: "Paranın hiç birikmemesinin gerçek sebebi.", move: "Paranın nihayet elinizde kalmasını sağlayacak şey." },
    ...
    healthSignal: { seen: "Bedeninizin sinyallerinden zaten fark ettiğiniz.", unseen: "Bedeninizin bu sahne üzerinden sürekli istediği, sizinse hep geçiştirdiğiniz şey.", know: "Dinlemeye başlayınca bedeninize bakma biçiminizde değişecek olan." },
    ...
    healthMind: { have: "İşler ağırlaştığında sizi zaten ayakta tutan şey.", thin: "Uzandığınız ama sizi henüz tam taşıyamayan destek.", use: "Sizi ayakta tutana yaslanınca ağır bir günün gerçekten hafiflediği yer." },
    ...
    healthBirth: { have: "Doğuma girerken zaten içinizde taşıdığınız güç.", thin: "Doğum yaklaşırken hâlâ eksik kaldığınız taraf.", use: "Doğum yaklaştıkça o güce uzanacağınız anın biçimi." },
  },
  ...
  topicClose: {
    ...
    loveGo: "Üstteki tek kelime bu kişiyle devam edip etmemenin cevabı; altındaki kart ise sebebi. Evetse yola devam etmenin sizden ne isteyeceğini, hayırsa neyin size 'dur' dediğini, henüz değilse önce neyin yatışması gerektiğini o kartta bulursunuz. Karta o tek kelimeden daha uzun bakın.",
    loveNeed: "Cevabınız ikinci kart, o yüzden en uzun orada durun — bu ilişkinin ihtiyacı, sizin gerçekten yapabileceğiniz bir şey. Kart yapılacak bir şeyi adlandırıyorsa cevap odur; bir boşluğu ya da gerginliği gösteriyorsa cevap onu doldurmaktır. İlk kart bunun neden şimdi gerektiğini, üçüncüsü ise o şey yerine oturunca ikinizin nereye kadar gideceğini söyler.",
    ...
    loveHonest: "Üstteki karar açıkça söyleyip söylememenin cevabı; altındaki kart ise sebebi — o yüzden karta o tek kelimeden daha uzun bakın. Evetse söylemenin aranızda neyi açacağını, hayırsa sözlerden önce neyin yerine oturması gerektiğini, henüz değilse onlara yer açılması için önce neyin yatışması gerektiğini o kartta bulursunuz. Hayır 'içinizde tutun' demek değil, 'bu hâliyle değil' demektir — şimdi söylerseniz önce neye çarpacağınızı ve bunun yerine nasıl söyleyeceğinizi orada okuyun.",
    ...
    crushConfess: "İtiraf edersem ne olur diye sordunuz — cevap üçüncü kartta, en uzun orada durun. Onu, söylediğinizde onun bunu nasıl karşılayacağı ve ikinizi nerede bırakacağı diye okuyun. İlk kart bir şey söylemeden önce aranızın durduğu yer; ikincisi onun cevabını biçimlendiren ruh hâli — o yüzden üçüncüyü tek başına değil, o ruh hâliyle söylediğinizde size dönecek karşılık olarak okuyun.",
    crushLetGo: "Üstteki kelime bunu bırakmanın zamanının gelip gelmediğinin cevabı; altındaki kart ise sebebi. O kartı o değil, siz diye okuyun — bırakmanın eşiğindeki siz. Kelime evetse kart, boşalttığınız yere neyin geleceğini; hayırsa neyin yarım kalıp sizi hâlâ tuttuğunu; henüz değilse cevabın netleşmesi için önce içinizde neyin netleşmesi gerektiğini gösterir. Kartta kelimeden daha uzun kalın — nasıl bırakacağınız da, neden tutacağınız da orada yazılı.",
    crushSilence: "Neden sustuğunu sordunuz — cevap ikinci kartta, en uzun orada durun. O kartın sözlerini onun hakkında okuyun: bir insan çıkmışsa, onun dikkati şu an oradadır; değilse, içinde bulunduğu hâl ya da aranıza giren şeydir. İlk kart bu sessizlikte ikinizin durduğu yer; üçüncüsü sebebi öğrendikten sonra ne yapacağınız — ulaşmak mı, beklemek mi.",
    ...
    workTalent: "İlk kart iyi olduğunuz şey — sorduğunuzun cevabı. Ağır bir kart çıktıysa bu bir kusur değil: o zeminden çoğu insandan daha sık geçmiş ve nasıl idare edileceğini çoktan öğrenmişsiniz demektir; yetenek, o bilmenin kendisidir. İkinci kart o yeteneğin nerede inceldiğini, üçüncüsü nerede gerçekten değer bulduğunu söyler. En uzun ilk kartta durun, onu nereye koyacağınızı ise üçüncüde arayın.",
    workStay: "Üstteki kelime bulunduğunuz yerde kalma konusundaki karar — evet, hayır ya da henüz değil — ve altındaki kart sebebi. Evetse kartı bu yerin size hâlâ verdiği ya da burada henüz bitirmediğiniz şey diye okuyun; hayırsa sizden sessizce aldığı şey diye; henüz değilse cevabın tutması için önce yerine oturması gereken şey diye. Karta kelimeden daha uzun bakın — hangi yöne giderseniz gidin, bir sonraki adım orada yazılı.",
    workPeople: "İlk kart sizin buraya taşıdığınız, ikincisi okumaya çalıştığınız kişi, üçüncüsü iş yerinde aranızda gerçekte işleyen şey. En uzun ikincisinde durun — istediğiniz okuma o — sonra üçüncüyle karşılaştırın: ikisi uyuşmuyorsa o boşluk, bu kişiyi yanlış okuduğunuz yerdir ve o boşluğu sizin tarafınızdan neyin açtığını çoğu zaman ilk kart söyler.",
    ...
    lifeSpend: "Üstteki karar bu harcamaya değip değmediğinin cevabı — evet, hayır ya da henüz değil — kartın metni ise sebebi. Evetse bu paranın size gerçekte ne aldığını, hayırsa harcamanın fiyatının ötesinde sizden ne götüreceğini ya da neden şimdi olmadığını, henüz değilse cüzdanı açmadan önce neyin yatışması gerektiğini orada bulursunuz. Kartı fiyat etiketi için değil, bunun için okuyun.",
    ...
    healthRest: "Üstteki kelime biraz durup dinlenmenin zamanının gelip gelmediğinin kararı; altındaki kart ise sebebi. Evetse kart, dinlenmenin size neyi geri vereceğini ya da nasıl dinlenirseniz gerçekten dinlenmiş olacağınızı gösterir. Hayır ya da henüz değilse, sizi şu an dinlenmekten alıkoyan şeyi. Kart dinlenmeyle ilgili görünmese bile, anlattığı şeyi şimdi durmanızla ilgiliymiş gibi okuyun. Hayır ya da henüz değil 'devam edin' demek değildir — dinlenmenin gerçekten dinlenme olabilmesi için önce bırakılması gereken bir şey var demektir. Bu, dinlenmeyi hak edip etmediğiniz değil, zamanlama sorusu. Kart tek kelimeden fazlasını söyler, o yüzden orada daha uzun kalın.",
