...
export default {
  ...
  topicLeads: {
    ...
    loveGo: { answer: "코드 수정 필요(문장은 그대로 둔다): ResultView 에서 CardBlock 에 `showLead={multi || !!reading.close}` 를 넘기고 64행 조건을 `{showLead && c.lead && (...)}` 로 바꾼다. 주제 질문에서 온 한 장 리딩만 lead 가 보이고, 오늘의 카드(close 없음)는 지금과 똑같이 유지된다." },
    loveNeed: { situation: "What the two of you actually have to work with right now.", action: "The one thing this relationship is asking of you now.", result: "What this relationship turns into once that need is met." },
    ...
    loveHonest: { answer: "Whether to say it out loud, and why." },
    ...
    crushAgain: { answer: "Whether there is a way back to each other, and why." },
    ...
    crushConfess: { situation: "Where things stand between you before you tell them how you feel.", action: "How to tell them, if you decide to go ahead.", result: "Where the two of you land once they know." },
    crushLetGo: { answer: "(문장 수정 아님, 코드 수정) ResultView.jsx CardBlock 에서 `{showPosition && c.lead && (` 를 `{c.lead && (` 로 바꾸거나, 주제에서 온 리딩(reading.close 가 있을 때)이면 한 장이어도 lead 를 보이게 한다. lead 문장은 그대로 둔다: \"Whether it is time to let this go, and why.\"" },
    crushSilence: { now: "Where the two of you stand now that they have gone quiet.", block: "What is actually keeping them from reaching out.", move: "What would get the two of you talking again." },
    ...
    workTalent: { have: "What you do well, even if you have never named it.", thin: "The skill you are still short on, right beside the one you have.", use: "Where that talent of yours really counts." },
    workStay: { answer: "(코드) ResultView.jsx CardBlock 의 lead 조건을 `{c.lead && (...)}` 로 바꿔 한 장짜리(yesno)에서도 lead 가 보이게 하거나, 최소한 topicLead 가 있을 때는 showPosition 과 무관하게 그린다. lead 문장은 그대로: \"Whether to stay where you are, and the reason why.\" / \"지금 자리에 더 머물러야 하는지, 그 답과 이유.\"" },
    ...
    lifeImportant: { pull: "Of everything on your plate right now, the one shouting loudest.", real: "The one that would still matter once the noise dies down.", first: "The first thing to pick up, now that you can see what matters." },
    ...
    lifeSave: { now: "How money comes and goes for you right now.", block: "Where your money keeps leaking out.", move: "What would let money finally stick around." },
    ...
    healthSignal: { seen: "The signal from your body that you have already noticed.", unseen: "What your body keeps asking for and you keep pushing past.", know: "What changes in how you look after your body once you listen." },
    ...
    healthMind: { have: "What holds you up when things get heavy.", thin: "The support you reach for that is not quite there yet.", use: "Where what holds you up actually lightens a heavy day." },
  ...
  topicClose: {
    ...
    loveGo: "The verdict above answers whether to keep going with this person. The card under it is the reason — what staying with them would actually look like — and that part is worth more than the yes or no itself.",
    loveNeed: "The first card is what the two of you have to work with, the second is the one thing to add, and the third is what the relationship turns into once that need is met. Your answer is the second card — what this relationship needs is something you can actually do.",
    ...
    loveHonest: "The verdict above answers whether to say it out loud. The card is the reason — what it sets in motion if you say it, and what it sets in motion if you don't — so read that part before you decide either way.",
    ...
    crushApproach: "The answer at the top says whether to make the first move; the card under it is why. Spend longer on the card than on the answer — read it for how to go about it, not just whether to.",
    ...
    crushAgain: "The answer at the top says whether there is a way back to each other; the card under it is the reason. Sit with the reason — if yes, it says what going back would ask of you; if no, what stands in the way; if not yet, what still has to settle first.",
    ...
    crushConfess: "You asked what happens if you tell them — that is the third card, so stay with it longest. The first shows where things stand before you say anything, and the second how to say it so the third has a chance.",
    crushLetGo: "The word at the top answers whether it is time to let this go. The card under it is the reason — and it also shows what letting go will take if the answer is yes, what is still worth holding on to if it is no, and what has to settle before you can tell if it is not yet.",
    crushSilence: "You asked why they went quiet — that is the second card, so stay with it longest. The first is the silence as it stands; the third is what would break it, and it only makes sense once the second has given you the reason.",
    ...
    workTalent: "The first card is the answer itself — what you do well — and the second marks where that strength runs thin, so you know where it stops. Stay with the first card longest, then let the third tell you where to put it to work.",
    workStay: "The word above is the call on staying — yes, no, or not yet. The card under it says why: read it for what staying gives you and what it costs.",
    ...
    lifeChoice: "The verdict above is the card's call on going for it — yes, no, or not yet. The card text is the reason; read it for what this move would actually ask of you.",
    ...
    lifeSpend: "The verdict above answers whether this one is worth spending on — the card text is the reason. Read it for what the money is really buying you, not just what it costs.",
    lifeImportant: "The second card is the answer to this question; the first is what has been shouting over it, and the third is where to start. Stay longest on the second — the first and third are only there to frame it.",
    ...
    lifeSave: "The first card is how money comes and goes for you now, the second is the leak, the third is what would get it to stay. You asked 'why', so sit longest with the second — the third only makes sense once you've seen the leak.",
    ...
    healthSignal: "The first card is what you already feel, the second is what your body has been asking for and you kept pushing past, and the third is what shifts in how you look after it once you listen. Stay longest with the second — that is the part your body has been waiting for you to notice.",
    ...
    healthRest: "The answer above says whether you can stop and rest for a while; the card is the reason — what the pause would give you back, or what needs settling first so the rest actually holds. Read it as a question of timing, not of whether you deserve the rest.",
    ...
    healthMind: "The first card is what already holds you up when things get heavy, the second is the support you keep reaching for that is not quite there yet, and the third is where leaning on the first actually makes the day lighter. Stay longest with the first — on the heavy days, start from what is already holding you before you try to build anything new.",
