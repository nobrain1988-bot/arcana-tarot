...
export default {
  ...
  result: {
    ...
    togetherOne: "Al leer esta carta",
  },
  ...
  topicLeads: {
    ...
    loveGo: { answer: "Lo que de verdad viene si sigues con esta persona: el motivo de que la respuesta de arriba haya salido así." },
    loveNeed: { situation: "Aquello con lo que de verdad cuentan los dos ahora mismo.", action: "Lo único que esta relación te pide añadir ahora: si la carta señala un hueco o una grieta, cubrirlo es la respuesta.", result: "En qué se convierte la relación una vez que eso se añade." },
    ...
    loveHonest: { answer: "Si decírselo de frente, y lo que de verdad se mueve entre los dos una vez dicho." },
    ...
    crushAgain: { answer: "Si hay camino de vuelta entre los dos, y qué forma toma ese camino al abrirse o al cerrarse." },
    ...
    crushConfess: { situation: "En qué punto están los dos antes de que le digas lo que sientes.", action: "Con qué ánimo decírselo, si decides lanzarte.", result: "Cómo se lo toma una vez que lo sabe, y dónde quedan los dos." },
    crushLetGo: { answer: "Si ya toca soltar a esa persona, y por qué: esta carta eres tú al borde de soltar, no esa persona." },
    crushSilence: { now: "Dónde están los dos ahora que esa persona ha callado.", block: "El motivo real de que esa persona haya callado: algo de su lado, o algo que se ha metido entre los dos.", move: "Lo que volvería a abrir la línea: un paso que puedes dar tú, o una señal de esperar de momento." },
    ...
    workTalent: { have: "Lo que ya haces bien, aunque nunca le hayas puesto nombre: manejar lo que muestra esta carta mejor que la mayoría.", thin: "La habilidad que aún te falta, justo al lado de la que tienes.", use: "Dónde cuenta de verdad ese talento tuyo." },
    workStay: { answer: "Si quedarte donde estás, y el porqué: lo que este sitio te está dando, o lo que te está quitando sin que lo notes." },
    workPeople: { you: "Lo que llevas tú cada vez que tratas con esa persona.", them: "Dónde está de verdad esa persona, detrás de lo que te muestra en el trabajo.", between: "Lo que pasa de verdad entre tú y esa persona en el trabajo." },
    ...
    lifeImportant: { pull: "De todo lo que tienes encima ahora, lo que más tira de ti.", real: "Lo que seguiría importándote cuando se apague el ruido.", first: "Lo primero que atender, ahora que ves lo que importa." },
    ...
    lifeSave: { now: "Cómo entra y sale el dinero en tu vida ahora mismo.", block: "El motivo real de que el dinero nunca te cunda.", move: "Lo que haría que el dinero por fin se quedara." },
    ...
    healthSignal: { seen: "La señal de tu cuerpo que ya has notado.", unseen: "Lo que tu cuerpo lleva pidiéndote a través de esta escena, y tú sigues pasando por alto.", know: "Lo que cambia en cómo cuidas tu cuerpo cuando por fin escuchas." },
    ...
    healthMind: { have: "Lo que ya te sostiene cuando todo pesa demasiado.", thin: "Aquello en lo que quieres apoyarte y que aún no puede sostenerte del todo.", use: "Dónde se hace más ligero un día pesado cuando te apoyas en lo que te sostiene." },
    ...
    healthBirth: { have: "La fuerza que ya llevas contigo de cara al parto.", thin: "Lo que aún te falta mientras el parto se acerca.", use: "El tipo de momento en que vas a echar mano de esa fuerza cuando el parto se acerque." },
  },
  ...
  topicClose: {
    ...
    loveGo: "La palabra de arriba responde si seguir adelante con esta persona; la carta de debajo es el motivo. Si es sí, muestra lo que te pediría seguir; si es no, lo que te está diciendo que pares; si es aún no, lo que todavía tiene que asentarse antes. Dedícale más tiempo a la carta que a la palabra.",
    loveNeed: "Tu respuesta es la segunda carta, así que quédate ahí más rato: lo que necesita esta relación es algo que puedes hacer tú. Si la carta nombra algo que hacer, esa es la respuesta; si señala un hueco o una grieta, la respuesta es cubrirlo. La primera carta dice por qué hace falta justo ahora; la tercera, hasta dónde llegan los dos cuando ya está.",
    ...
    loveHonest: "El veredicto de arriba responde si decírselo de frente; la carta de debajo es el motivo, así que dedícale más tiempo a la carta que a la palabra. Si es sí, la carta dice lo que se abre entre los dos al decirlo. Si es no, lo que hay que asentar antes que las palabras. Si es aún no, lo que tiene que calmarse para que haya sitio para ellas. Un no aquí no significa «cállatelo», sino «así no»: lee la carta para ver con qué chocarías si lo dijeras ahora, y cómo decirlo en su lugar.",
    ...
    crushApproach: "La respuesta de arriba dice si dar el primer paso; la carta de debajo es el porqué. Dedícale más tiempo a la carta que a la respuesta: si es sí, dice cómo acercarte; si es no, con qué te toparías si te mueves ahora; si es aún no, lo que tiene que asentarse antes de que lo hagas.",
    ...
    crushAgain: "La respuesta de arriba dice si hay camino de vuelta entre los dos; la carta de debajo es la forma de ese camino. Hable de lo que hable la carta, léela como el camino de vuelta: si es sí, muestra cómo se abre y qué te pide; si es no, qué lo está cerrando; si es aún no, qué tiene que asentarse antes. Quédate con la carta más rato que con la palabra de arriba.",
    ...
    crushConfess: "Preguntaste qué pasa si te declaras, y eso es la tercera carta, así que quédate ahí más rato. Léela como la forma en que se lo toma esa persona y dónde quedan los dos después. La primera muestra en qué punto están antes de decir nada, y la segunda es el ánimo con el que decirlo, el que marca su respuesta: así que lee la tercera como lo que vuelve cuando se lo dices así, no por separado.",
    crushLetGo: "La palabra de arriba responde si ya toca soltarlo; la carta de debajo es el motivo. Lee esa carta como tú, no como esa persona: tú, al borde de soltar. Si es sí, la carta muestra lo que entra en el hueco que dejas libre; si es no, lo que sigue sin cerrarse y aún te retiene; si es aún no, lo que tiene que aclararse dentro de ti antes de que la respuesta pueda aclararse. Quédate más rato con la carta que con la palabra: cómo soltar, o por qué seguir agarrando, está escrito ahí.",
    crushSilence: "Preguntaste por qué se ha quedado en silencio, y eso es la segunda carta, así que quédate ahí más rato. Lee lo que dice como si hablara de esa persona: si aparece alguien, ahí es donde tiene puesta la atención ahora mismo; si no, es el estado en que está, o lo que se ha metido entre los dos. La primera carta es dónde están los dos en medio del silencio; la tercera, lo que haces tú cuando ya sabes el motivo: acercarte, o esperar.",
    ...
    workTalent: "La primera carta es lo que haces bien, la respuesta a lo que preguntaste. Si salió pesada, no es ningún defecto: quiere decir que has pasado por ese terreno más veces que la mayoría y ya sabes manejarlo, y ese saber es el talento. La segunda carta es dónde flaquea ese talento; la tercera, dónde cuenta de verdad. Quédate más con la primera, y busca en la tercera dónde ponerlo a trabajar.",
    workStay: "La palabra de arriba es el veredicto sobre quedarte donde estás: sí, no o aún no. La carta de debajo es el motivo. Si es sí, léela como lo que este sitio aún te da, o lo que todavía te queda por terminar aquí; si es no, como lo que te está quitando sin que lo notes; si es aún no, como lo que tiene que asentarse para que la respuesta se sostenga. Dedícale más tiempo a la carta que a la palabra: te quedes o te vayas, el siguiente paso está escrito ahí.",
    workPeople: "La primera carta es lo que traes tú, la segunda la persona que intentas leer y la tercera lo que pasa de verdad entre los dos. Quédate más con la segunda, que es la lectura que pediste, y contrástala con la tercera: donde no coincidan, esa grieta es justo donde estabas leyendo mal a esa persona, y la primera carta te dice qué la abre desde tu lado.",
    ...
    lifeChoice: "La palabra de arriba es el veredicto sobre lanzarte: sí, no o aún no. La carta de debajo es el motivo. Si es sí, dice lo que te pediría lanzarte; si es no, lo que te está diciendo que no; si es aún no, lo que tiene que asentarse antes de decidir. Dedícale más tiempo a la carta que a la palabra: la palabra solo dice si lanzarte; la carta dice qué hacer con ello.",
    ...
    lifeSpend: "El veredicto de arriba dice si este gasto merece la pena: sí, no o aún no. El texto de la carta es el motivo. Si es sí, te dice qué te compra de verdad ese dinero; si es no, qué te quita ese gasto además del precio, o por qué ahora no; si es aún no, qué tiene que asentarse antes de abrir la cartera. Léelo para eso, no para saber cuánto cuesta.",
    lifeImportant: "Preguntaste qué es lo más importante ahora, y la segunda carta es la respuesta: quédate ahí más rato. La primera es dónde ha estado de verdad tu atención: si dice lo mismo que la segunda, tu cabeza ya está en su sitio; si dice otra cosa, hasta ahí se te había ido la mirada. La tercera es lo primero que atender para cuidar eso que importa.",
    ...
    lifeSave: "La primera carta es cómo entra y sale hoy el dinero, la segunda el motivo real de que nunca te cunda y la tercera lo que haría que por fin se quedara. Preguntaste por qué, así que quédate más con la segunda: la tercera solo cobra sentido cuando has visto el motivo. Si la segunda es una carta oscura, esa es la fuga; si parece una buena noticia, ahí es adonde se va el dinero antes que a ningún otro sitio.",
    ...
    healthSignal: "La primera carta es la señal de tu cuerpo que ya has sentido, la segunda lo que tu cuerpo lleva pidiendo detrás de ella, y la tercera lo que cambia en cómo lo cuidas cuando oyes esa petición. Lee la primera y la segunda una junto a otra: el hueco entre las dos es la parte que no estabas oyendo. Quédate más con la segunda: salga la escena que salga, es un dibujo de lo que quiere tu cuerpo, así que léela en palabras de tu cuerpo. Eso es lo que llevaba esperando que notaras.",
    ...
    healthRest: "La palabra de arriba es el veredicto sobre si puedes parar y descansar un tiempo; la carta de debajo es el motivo. Si es sí, la carta muestra lo que te devolvería el descanso, o cómo descansar para que cuente. Si es no o aún no, muestra lo que te impide descansar ahora mismo. Aunque la carta no parezca hablar de descanso, lee lo que describe como si fuera tú parando ahora. Si sale no o aún no, no te está diciendo «aguanta»: te dice que algo hay que soltar antes para que el descanso sea descanso de verdad. Es cuestión de cuándo, no de si te lo mereces. La carta dice más que la palabra, así que quédate ahí más rato.",
    ...
    healthMind: "La respuesta es la primera carta: aquello en lo que puedes apoyarte cuando todo pesa no es algo que tengas que construir, ya te está sosteniendo. La segunda es el apoyo que se tambalea si le cargas todo el peso: léela como una señal de pasar ese peso a la primera. La tercera es qué parte de un día pesado se aligera primero cuando lo haces. Quédate más con la primera: en los días pesados, antes de buscar nada más, empieza por lo que ya te sostiene.",
    ...
    healthBirth: "La primera carta es la fuerza con la que ya cuentas para el parto, la segunda lo que aún te falta y la tercera el tipo de momento en que vas a echar mano de esa fuerza. Quédate más con la primera: es la respuesta a lo que preguntaste y ya está en ti. La segunda solo te enseña dónde tratarte con más suavidad a medida que se acerca el día, y la tercera no es un pronóstico de ese día, sino el momento en que acordarte de la primera carta: si la tercera parece pesada, justo para ese momento está la primera.",
  },
