...
export default {
  ...
  topicLeads: {
    ...
    loveGo: { answer: "Se vale continuar com essa pessoa, e por quê." },
    loveNeed: { situation: "O que vocês dois têm em mãos agora, de verdade.", action: "A única coisa que essa relação está pedindo de você agora.", result: "No que essa relação vira depois que esse pedido é atendido." },
    ...
    loveHonest: { answer: "Se é para falar isso em voz alta, e por quê." },
    ...
    crushAgain: { answer: "Se existe um caminho de volta para vocês dois, e por quê." },
    ...
    crushConfess: { situation: "Em que pé vocês estão antes de você se declarar.", action: "Como se declarar, se você decidir ir em frente.", result: "Onde vocês dois ficam depois que essa pessoa souber." },
    crushLetGo: { answer: "Se já é hora de soltar essa pessoa, e por quê." },
    crushSilence: { now: "Em que pé vocês dois estão agora que essa pessoa sumiu.", block: "O que está impedindo essa pessoa de aparecer, de verdade.", move: "O que faria vocês dois voltarem a se falar." },
    ...
    workTalent: { have: "O que você faz bem, mesmo sem nunca ter dado nome a isso.", thin: "A habilidade que ainda falta, bem do lado da que você tem.", use: "Onde esse seu talento conta de verdade." },
    workStay: { answer: "Se é para ficar onde você está, e o motivo." },
    ...
    lifeImportant: { pull: "De tudo que você tem para dar conta agora, o que grita mais alto.", real: "O que ainda vai importar quando o barulho baixar.", first: "A primeira coisa a pegar, agora que você vê o que importa." },
    ...
    lifeSave: { now: "Como o dinheiro entra e sai para você agora.", block: "Por onde o seu dinheiro vive vazando.", move: "O que faria o dinheiro finalmente ficar." },
    ...
    healthSignal: { seen: "O sinal do seu corpo que você já percebeu.", unseen: "O que o seu corpo vive pedindo e você vive atropelando.", know: "O que muda no jeito de cuidar do seu corpo quando você escuta." },
    ...
    healthMind: { have: "O que segura você quando tudo fica pesado.", thin: "O apoio que você procura e que ainda não está firme.", use: "Onde o que segura você deixa um dia pesado mais leve, de verdade." },
  ...
  topicClose: {
    ...
    loveGo: "A resposta ali em cima diz se vale continuar com essa pessoa. O texto da carta é o motivo — como seria, na prática, seguir com ela — e essa parte vale mais que o sim ou o não.",
    loveNeed: "A primeira carta é o que vocês têm em mãos, a segunda é a única coisa a acrescentar, e a terceira é no que a relação vira quando isso é atendido. A resposta é a segunda carta — o que essa relação precisa é algo que você consegue fazer.",
    ...
    loveHonest: "A resposta ali em cima diz se é para falar em voz alta. A carta é o motivo — o que muda se você fala, e o que muda se você engole — então leia essa parte antes de decidir para um lado ou para o outro.",
    ...
    crushApproach: "A resposta lá em cima diz se é para dar o primeiro passo; a carta embaixo é o porquê. Fique mais tempo na carta do que na resposta — leia nela como dar esse passo, não só se é para dar.",
    ...
    crushAgain: "A resposta lá em cima diz se existe volta para vocês dois; a carta embaixo é o motivo. Fique com o motivo — se for sim, ele diz o que voltar pediria de você; se for não, o que está no caminho; se for ainda não, o que precisa assentar primeiro.",
    ...
    crushConfess: "Você perguntou o que acontece se você se declarar — isso é a terceira carta, então fique mais nela. A primeira mostra em que pé as coisas estão antes de você dizer qualquer coisa, e a segunda, como dizer para que a terceira tenha chance.",
    crushLetGo: "A palavra ali em cima responde se já é hora de soltar. A carta embaixo é o motivo — e mostra também o que soltar vai exigir se for sim, o que ainda vale segurar se for não, e o que precisa assentar antes de dar para saber se for ainda não.",
    crushSilence: "Você perguntou por que essa pessoa sumiu — isso é a segunda carta, então fique mais nela. A primeira é o silêncio como ele está; a terceira é o que quebraria esse silêncio, e ela só faz sentido depois que a segunda deu o motivo.",
    ...
    workTalent: "A primeira carta é a resposta em si — o que você faz bem — e a segunda marca onde essa força enfraquece, para você saber onde ela para. Fique mais na primeira, e deixe a terceira dizer onde colocar isso para trabalhar.",
    workStay: "A palavra ali em cima é a decisão sobre ficar — sim, não ou ainda não. A carta embaixo diz por quê: leia nela o que ficar dá a você e o que custa.",
    ...
    lifeChoice: "A resposta ali em cima é a decisão da carta sobre ir nessa — sim, não ou ainda não. O texto da carta é o motivo; leia nele o que esse passo pediria de você, na prática.",
    ...
    lifeSpend: "A resposta ali em cima diz se esse gasto vale a pena — o texto da carta é o motivo. Leia nele o que esse dinheiro está comprando para você de verdade, não só quanto custa.",
    lifeImportant: "A segunda carta é a resposta a essa pergunta; a primeira é o que vinha gritando por cima dela, e a terceira é por onde começar. Fique mais na segunda — a primeira e a terceira só estão ali para situar essa resposta.",
    ...
    lifeSave: "A primeira carta é como o dinheiro entra e sai para você hoje, a segunda é o vazamento, a terceira é o que faria ele ficar. Você perguntou por quê, então fique mais na segunda — a terceira só faz sentido depois de ver o vazamento.",
    ...
    healthSignal: "A primeira carta é o que você já sente, a segunda é o que o seu corpo vinha pedindo e você atropelava, e a terceira é o que muda no jeito de cuidar dele quando você escuta. Fique mais na segunda — é a parte que o seu corpo estava esperando você notar.",
    ...
    healthRest: "A resposta ali em cima diz se dá para parar e descansar um pouco; a carta é o motivo — o que a pausa devolve a você, ou o que precisa assentar antes para o descanso render. Leia como uma questão de hora certa, não de merecer ou não o descanso.",
    ...
    healthMind: "A primeira carta é o que já segura você quando pesa, a segunda é o apoio que você vive procurando e ainda não está firme, e a terceira é onde se apoiar na primeira deixa o dia mais leve de verdade. Fique mais na primeira — nos dias pesados, comece pelo que já está segurando você antes de tentar construir algo novo.",
